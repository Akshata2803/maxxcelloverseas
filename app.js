...
app.get('/blog-page-10-tips-to-score-a-perfect-170-In-gre-quant', (req, res) => {
    const params = { }
    res.status(200).render('blog-page-10-tips-to-score-a-perfect-170-In-gre-quant.pug', params)
  }) 
app.get('/blog-page-10-tips-to-crack-the-IELTS-Exam', (req, res) => {
    const params = { }
    res.status(200).render('blog-page-10-tips-to-crack-the-IELTS-Exam.pug', params)  
  }) 
app.get('/blog-page-10-Tips-to-remember-before-writing-a-professional-SOP-for-higher-Ranked-Universities', (req, res) => {
    const params = { }
    res.status(200).render('blog-page-10-Tips-to-remember-before-writing-a-professional-SOP-for-higher-Ranked-Universities.pug', params)
  })  
app.get('/blog-page-Top-10-Programs-for-Data-Science-in-USA', (req, res) => {
    const params = { }
    res.status(200).render('blog-page-Top-10-Programs-for-Data-Science-in-USA.pug', params)
  })  
app.get('/blog-page-Top-Universities-to-consider-to-study-in-Australia', (req, res) => {
    const params = { }
    res.status(200).render('blog-page-Top-Universities-to-consider-to-study-in-Australia.pug', params)
  }) 
app.get('/blog-page-Why-study-in-Germany-Study-the-German-way', (req, res) => {
    const params = { }
    res.status(200).render('blog-page-Why-study-in-Germany-Study-the-German-way.pug', params)
  })   
